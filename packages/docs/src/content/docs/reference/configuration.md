...
| `shadow_transform.enabled` | boolean | `false` | Dev flag: mirror every transform pass to the Magic Context Rust module over subc and byte-compare outputs. No behavior impact; default off. |
